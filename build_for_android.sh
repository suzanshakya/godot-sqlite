...
#export ANDROID_NDK_ROOT=/home/callbreak/android/android-ndk-r22b
...
#scons platform=android bits=64 android_arch=armv7 target=release generate_bindings=yes -j 1
...
#scons platform=android bits=64 android_arch=arm64v8 target=release generate_bindings=yes -j 1
...
#scons platform=android bits=64 android_arch=x86 target=release generate_bindings=yes -j 1
...
#scons platform=android bits=64 android_arch=x86_64 target=release generate_bindings=yes -j 1
